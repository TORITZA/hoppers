...
public class HoppersGUI extends Application implements Observer<HoppersModel, String> {
    ...
    public void creditsScreen() {
        ...
        Text RITcred = new Text("Regardless, none of this would have been possible without the instruction " +
                "and tutelage of RIT's CS department. While it is my own, they really propelled this project " +
                "into motion, even providing the assets for the water and lily pad board tiles. Additionally, both" +
                " the Configuration and Observer interfaces were implemented by them.");
        ...
        // Fair Use claim
        Label disclaimer = new Label("Pokémon is a trademark of Nintendo, Creatures Inc., and Game Freak. This is a" +
